...
*/
export declare class IamServiceAccountIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "yandex_iam_service_account_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: IamServiceAccountIamPolicyConfig);
    private _id?;
    get id(): string;
    set id(value: string);
    resetId(): void;
