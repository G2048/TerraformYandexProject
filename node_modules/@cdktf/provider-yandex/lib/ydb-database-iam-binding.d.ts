...
*/
export declare class YdbDatabaseIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "yandex_ydb_database_iam_binding";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: YdbDatabaseIamBindingConfig);
    private _databaseId?;
    ...
    set sleepAfter(value: number);
    resetSleepAfter(): void;
    get sleepAfterInput(): number | undefined;
