...
*/
export declare class DataYandexComputeDiskPlacementGroup extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "yandex_compute_disk_placement_group";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config?: DataYandexComputeDiskPlacementGroupConfig);
