...
*/
export declare class IamServiceAccountStaticAccessKey extends cdktf.TerraformResource {
    static readonly tfResourceType = "yandex_iam_service_account_static_access_key";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: IamServiceAccountStaticAccessKeyConfig);
